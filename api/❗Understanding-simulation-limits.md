...
-   [What counts as a simulation?](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#what-counts-as-a-simulation)
-   [Tracking simulations on the Platform](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#tracking-simulations-on-the-platform)
-   [Tracking simulations using BRAIN API](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#tracking-simulations-using-brain-api)
    -   [Simulation limit details in API response](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#simulation-limit-details-in-api-response)
-   [Managing simulation limits](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#managing-simulation-limits)
-   [How to use simulations effectively?](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#how-to-use-simulations-effectively)
    -   [Analyze data fields](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#analyze-data-fields)
    -   [Use BRAIN Labs for deeper insights](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#use-brain-labs-for-deeper-insights)
    -   [Utilize Alpha statistics](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#utilize-alpha-statistics)
    -   [Optimize search space](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#optimize-search-space)
        -   [Select data fields](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#select-data-fields)
    -   [Select operators](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#select-operators)
        -   [Select parameters](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#select-parameters)
        -   [Select neutralization](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#select-neutralization)
    -   [Tips](https://platform.worldquantbrain.com/learn/documentation/brain-api/understanding-simulation-limits#tips)
