...
-   [Potential steps to implement a local hash-based simulation cache](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#potential-steps-to-implement-a-local-hash-based-simulation-cache)
    -   [Hash your Alpha configuration](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#hash-your-alpha-configuration)
    -   [Set up cache file](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#set-up-cache-file)
    -   [Add simulation to the cache](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#add-simulation-to-the-cache)
    -   [Check if an Alpha was already simulated](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#check-if-an-alpha-was-already-simulated)
-   [Examples](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#examples)
    -   [Build alpha configuration](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#build-alpha-configuration)
    -   [Filter out alphas that were already simulated (using the cache)](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#filter-out-alphas-that-were-already-simulated-using-the-cache)
    -   [Run multi-simulation only for new alphas](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#run-multi-simulation-only-for-new-alphas)
-   [Tips for success](https://platform.worldquantbrain.com/learn/documentation/brain-api/how-can-you-avoid-duplicate-simulations#tips-for-success)
